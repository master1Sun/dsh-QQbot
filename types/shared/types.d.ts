...
export interface BotState {
     ...
     */
    mergeRecords: Map<string, {
        record: PassiveReplyRecord;
        at: number;
    }>;
 ...
 */
export declare const SILENT_MARKER = "[[NO_SEND]]";
/**
...
export declare function atBot(payload: QqMessagePayload): boolean;
/**
...
/** 支持接入的消息事件类型。 */
export declare const MESSAGE_EVENT_TYPES: Set<string>;
/** 解析消息事件体；结构不符返回 null。 */
export declare function parseMessagePayload(event: QqWebhookEvent): {
    eventType: string;
    payload: QqMessagePayload;
} | null;
/** 消息发送者 openid（群聊为 member_openid，单聊为 user_openid，兼容 author.id）。 */
export declare function senderIdOf(payload: QqMessagePayload): string;
/** 消息回复目标（群聊 / 单聊）。 */
export declare function replyTargetOf(eventType: string, payload: QqMessagePayload): ReplyTarget | null;
