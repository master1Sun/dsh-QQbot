...
function QqbotSettingsTab({ rpcCall }) {
  ...
  const [overrideModal, setOverrideModal] = React2.useState(null);
      ...
      h(
        ...
        h(
          ...
          h(
            ...
            h("span", { className: "qbot-brandVersion" }, `v${true ? "0.1.2" : "0.0.2"}`),
            h("button", {
      ...
      h(
        ...
        h(
          ...
          h(
            "div",
            { className: "qbot-editForm" },
            overrideModal.error ? h("div", { className: "qbot-modalState qbot-modalError" }, overrideModal.error) : null,
            scheduleField(
              "群 openid",
              "要单独配置的群 openid（o 开头的长串）。可在群里让 AI 用 /session 查看。",
              TextInput({
                className: "qbot-input qbot-mono",
                value: String(overrideModal.draft.openid ?? ""),
            ...
            scheduleField(
              ...
              h(
                ...
                {
                  className: "qbot-settingSelect",
                  value: String(overrideModal.draft.groupFullReply),
            ...
            scheduleField(
              ...
              h(
                ...
                {
                  className: "qbot-settingSelect",
                  value: String(overrideModal.draft.valueThreshold),
            ...
            scheduleField(
              ...
              h(
                ...
                {
                  className: "qbot-settingSelect",
                  value: String(overrideModal.draft.atContextMessages),
            ...
            scheduleField(
              ...
              h(
                ...
                {
                  className: "qbot-settingSelect",
                  value: String(overrideModal.draft.groupCooldownMs),
            ...
            scheduleField(
              ...
              h(
                ...
                {
                  className: "qbot-settingSelect",
                  value: String(overrideModal.draft.senderCooldownMs),
            ...
            scheduleField(
              ...
              h(
                ...
                {
                  className: "qbot-settingSelect",
                  value: String(overrideModal.draft.replyChunkChars),
            ...
            scheduleField(
              ...
              h(
                ...
                {
                  className: "qbot-settingSelect",
                  value: String(overrideModal.draft.maxRepliesPerMessage),
            ...
            scheduleField(
              ...
              h(
                ...
                {
                  className: "qbot-settingSelect",
                  value: String(overrideModal.draft.markdownReply),
            ...
            scheduleField(
              ...
              h(
                ...
                {
                  className: "qbot-settingSelect",
                  value: String(overrideModal.draft.memoryEnabled),
            ...
            scheduleField(
              ...
              h(
                ...
                {
                  className: "qbot-settingSelect",
                  value: String(overrideModal.draft.agentPresetChat),
            ...
            scheduleField(
              ...
              TextArea({
                rows: 2,
                value: String(overrideModal.draft.bannedWords ?? ""),
